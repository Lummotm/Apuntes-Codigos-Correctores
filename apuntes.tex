...
\]
La factorización completa del espacio se obtiene seleccionando un representante minimal por cada clase diferenciada: $X^n - 1 = \prod_{j} m_j(X)$. Construir el polinomio generador $g(x)$ se reduce a elegir qué subconjunto de estos vectores de raíces mínimos compondrán el ideal del código.
